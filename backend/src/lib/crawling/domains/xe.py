...
CONFIG = CrawlerRunConfig(
    ...
    excluded_selector=(
        ...
        "#siteHeader, " #cambia, id = header
        # Secondary site navigation bar (Convert / Send Money / Charts / ...)
        # shown on the currency converter page just below the header
        ...
        "div[class*='animate-slideFromLeft']"#aggiungi bottom-0 left-0 z-50
    ),
    remove_forms=True,
)
